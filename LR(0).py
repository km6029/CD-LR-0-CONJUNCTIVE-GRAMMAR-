...
if __name__ == '__main__':  
    ...
    print("\n")  
    with open("C:\\Users\Karthikeya Reddy\Downloads\\"+str(num) + ".txt", 'r') as fp:         
    ...
    try:  
        ...
        if accepted:  
            ...
            print("The string {0} is parsable! Please find the parsing table in " ,"parsable_strings/{1}/{2}.txt.".format(string, num, compressed_name))  
        else:  
